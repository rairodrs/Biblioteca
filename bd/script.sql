...
('admin3', 'Patricia', '$2y$10$QYjHew7dYu7hTz8xz1p9l.AL2Xi5dQ97QtFI2vjGGvUXTFBMrtwoe', 'admin'),
('admin2', 'Patricia', '$2y$10$FzM5GrAPWVWGCylZDUum5OUQorYJ1e.GHi3Q23Av7s6om.Rn/7gD6', 'admin'),
('admin', 'Patricia Ziviani', '$2y$10$UpMQCcir.v649HrdLvUXiOC/ftU7xWhSxm8QhX.VzSe9LZHhvW/Ty', 'admin'),
('teste', 'João da Silva', '$2y$10$w7on7cjLKNtmJUGkiHIXoOQAwTJzkgxXqLmjtfDUkCXmQK0784.IS', 'editor');


INSERT INTO usuarios (usuario,nome,senha,tipo) VALUES
('paty', 'Patricia', '$2y$10$iNKPsNwEw2xS8dOLq36aCO4vYqR6/TLD.qDp7ITD6gRt0FPPCmYyy', 'admin');
...
-- INSERT INTO jogos(nome,genero,produtora,descricao,nota)VALUES('$nome','$genero','$produtora','$descricao')";

select cod,genero from generos;
